...
model_base='models/deploy_resnet101-base-lin.prototxt'
model_repeat='models/repeat_thin_part_conv_sum.prototxt'
rcnn_layer='models/rcnn_layer_nonlin.pt'

model_out='models/deploy_res101_multi_conv_sum.prototxt'
